...
export default function Hero() {
  return (
    <div className="relative z-0 flex h-[512px] w-full flex-col items-center justify-center overflow-visible bg-secondary text-left sm:h-[340px] md:h-[384px] md:flex-row">
      ...
      <div className="0 absolute left-0 top-0 flex h-full w-full flex-col items-center justify-start">
        <Navbar />
        <div className="grid h-full w-full grid-cols-1 items-center justify-center gap-8 px-2 md:gap-16">
          <div className="flex h-full flex-col justify-center gap-4 sm:w-4/5">
            <h1 className="text-left text-3xl font-medium leading-8 tracking-tighter text-secondary min-[414px]:w-3/5 md:text-left 2xl:text-6xl">
            ...
            <h2 className="w-3/4 text-left text-sm tracking-wide text-primary-foreground min-[414px]:w-[60%] md:text-left md:text-primary/80 min-[896px]:w-[34%] 2xl:text-2xl">
