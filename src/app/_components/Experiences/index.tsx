...
export default async function Experiences() {
  ...
  return (
    <div className="relative z-0 flex h-full min-h-screen w-full flex-col items-center justify-center gap-16 bg-gradient-to-b from-primary-foreground/20  to-secondary-foreground/30  text-left">
