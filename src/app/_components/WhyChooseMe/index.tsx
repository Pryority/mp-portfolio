export default function WhyChooseMe() {
  return (
    <div className="relative top-1/2 z-0 flex min-h-screen w-full flex-col items-center justify-center bg-gray-800 text-left sm:top-[512px] md:flex-row 2xl:top-0 2xl:min-h-[40vh]">
      <div className="absolute inset-0 top-0 z-0 h-[500px] -translate-y-80 bg-gray-800" />
      <div className="grid w-full items-center justify-center gap-8 md:gap-16">
        <div className="z-10 flex h-fit w-full flex-col items-center gap-8">
          <h4 className="text-center text-4xl font-medium tracking-tight  text-lime-300 dark:text-amber-400  md:text-left">
            Why Choose Me
          </h4>
          <p className="w-5/6 text-center text-base tracking-wide text-primary-foreground md:text-left 2xl:text-xl">
